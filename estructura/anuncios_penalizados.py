...
# Board de Anuncios Penalizados
BOARD_ID = 7019548313

# Vamos a filtrar por la columna "date"
COLUMN_ID_FECHA = "date"

# La tabla en BigQuery donde insertaremos los datos
BIGQUERY_TABLE_ID = "operations.anuncios_penalizados"

# Ajusta el rango de fechas según necesites
START_DATE = datetime.date(2024, 7, 11)
END_DATE   = datetime.date(2027, 1, 1)

# Iteraremos día a día
DELTA = datetime.timedelta(days=1)

# Mapeo de las columnas (según CREATE TABLE)
COLUMN_TYPE_MAP = {
    "id": "NUMERIC",
    "name": "STRING",
